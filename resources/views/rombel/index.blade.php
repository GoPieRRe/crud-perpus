	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h1><i class="fas fa-address-book"></i> Rombel</h1>
					</div>
					<div class="col-sm-6">
						<a href="{{ route('rombel.create') }}" class="btn btn-success"><i class="fas fa-plus"></i>Add Rombel</a>
					</div>
				</div>
			</div>
				...
				<tbody>
					 <tr>
                         ...
                         <td>
                             ...
                             <a href="{{ route('rombel.edit',$b->id) }}" class="btn btn-info"><i class="fas fa-edit"></i></a>
