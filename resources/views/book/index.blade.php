	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h1><i class="fas fa-book"></i>Book</h1>
					</div>
					<div class="col-sm-6">
						<a href="{{ route('book.create') }}" class="btn btn-success"><i class="fas fa-plus"></i>Add New Book</a>
					</div>
				</div>
			</div>
				...
				<tbody>
					 <tr>
                         ...
                         <td>
                             ...
                             <a href="{{ route('book.edit',$b->id) }}" class="btn btn-info"><i class="fas fa-edit"></i></a>
